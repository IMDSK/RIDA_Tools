...
# # Main function to run the entire process
# def process_train_aoi(selected_folder):
#     # Step 1: SHP Creation
#     csv_file = os.path.join(selected_folder, "Coordinate.csv")
#     execute_script(csv_file, selected_folder)
...
# fc.title = '<b>Select the folder containing the required files:</b>'
# run_button = widgets.Button(description="Run Process", button_style='success')
# output = widgets.Output()

# def on_button_click(b):
#     selected_folder = fc.selected
#     if selected_folder:
#         with output:
#             clear_output()
#             process_train_aoi(selected_folder)
#     else:
#         with output:
#             clear_output()
