...
def crop_and_show_images(base_path, shp_directory, image_folder, result_folder):
    ...
    for shp_file in os.listdir(shp_directory):
        if shp_file.endswith('.shp'):
            ...
            area_name = os.path.splitext(shp_file)[0]
            area_result_path = os.path.join(results_path, area_name)
            ...
            plt.show()
            print(f"Cropped images saved for {shp_file} in the '{area_name}' folder within 'results'.")